...
<%@ include file="/common/register/header.jsp" %>

<div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" filter-color="black"
         style="background-image: url('../template/admin/assets/img/register.jpg'); background-size: cover; background-position: top center;">

        <dec:body/>
        <%@ include file="/common/register/footer.jsp" %>
